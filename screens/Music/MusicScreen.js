      ...
      <View>
        <View style={styles.container1}>
          <TouchableOpacity onPress={songs}>
            <Text style={enableComponent ? styleButtomEnable : styleButtomDesable}>Songs</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={playlists}>
            <Text style={enableComponent ? styleButtomDesable : styleButtomEnable}>Playlist</Text>
          </TouchableOpacity>
        </View>
      </View>
      <View style={{ padding: 20, marginTop: -10 }}>
        {enableComponent ? <SongsScreen navigation={navigation} /> : <PlaylistScreen />}
      </View>
    </ScrollView>
  );
};
